...
class EmptyState extends React.Component {
    render() {
      const {title, description, illustration, width, height, navigation} = this.props
        ...
        return (
          <View style={styles.container} >
            ...
            {(this.props && this.props.goTo) &&
              <TouchableOpacity onPress={() => navigation.navigate(this.props.goTo)}>
                <Text style={styles.link}>Alterar minhas configurações</Text>
              </TouchableOpacity>
            }
          </View>
        );
